<template>
      ...
      <div>
        ...
        <div class="mb-[20px]">
          ...
          > -->
            ...
            <select class="border-2 border-black ml-[50px] pt-[10px] pb-[10px] pr-[60px] pl-[60px]">
        ...
        <div class="mb-[20px]">
            ...
            <select class="border-2 border-black ml-[75px] pt-[10px] pb-[10px] pr-[60px] pl-[60px]">
  ...
  <footer class="footer">
    <div class="flex items-center">
      ...
      <a href=""
        ><img
          src="https://cdn4.iconfinder.com/data/icons/logos-3/565/Mastercard-logo-64.png"
          alt=""
          width="50px"
          height="50px"
          class="num1"
      ...
      <a href=""
        ><img
          src="https://cdn3.iconfinder.com/data/icons/payment-method-1/64/_Paypal-39-64.png"
          alt=""
          width="50px"
          height="50px"
          class="num1"
